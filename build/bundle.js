...
window.onload = function() {
	...
	function renderYear(){
		__WEBPACK_IMPORTED_MODULE_0_d3__["json"]("static/names_parsed/yob" + currentDisplayYear + ".json", function(data) {
			var filteredData = filterData(data);
			drawYear(filteredData);
		});
		function drawYear(year){
			var clearAll = __WEBPACK_IMPORTED_MODULE_0_d3__["select"]('.d3target').selectAll("*").remove();
	...
	//      .style("font-size", function(d){ return getRadius(d)})
			...
			var makeCircles = makeSvgs.append("circle")
				...
				.style("fill", function(d){
					return d.sex == 'M' ? __WEBPACK_IMPORTED_MODULE_1_randomcolor__({hue:'blue', luminocity: 'dark'}) : __WEBPACK_IMPORTED_MODULE_1_randomcolor__({hue:'pink', luminocity:'dark'});
				});
	...
	function registerInputListeners(){
		__WEBPACK_IMPORTED_MODULE_2_jquery__('#yearSelector').change(function(e){
			...
			__WEBPACK_IMPORTED_MODULE_2_jquery__('#currentYear').html(currentDisplayYear);
			renderYear();
		});

		__WEBPACK_IMPORTED_MODULE_2_jquery__('#sexSelector').change(function(e){
			currentDisplaySex = e.currentTarget.checked ? 'M' : 'F';
			__WEBPACK_IMPORTED_MODULE_2_jquery__('#currentSex').html(currentDisplaySex);
			renderYear();
		});

		__WEBPACK_IMPORTED_MODULE_2_jquery__('#maxOccurancesInput').change(function(e){
			// debugger;
			if(e.currentTarget.value == ''){
				currentMaxOccurances = Infinity;
				__WEBPACK_IMPORTED_MODULE_2_jquery__('#currentMaxOccurances').html('Unlimited');
			} else {
				currentMaxOccurances = e.currentTarget.value;
				__WEBPACK_IMPORTED_MODULE_2_jquery__('#currentMaxOccurances').html(currentMaxOccurances);
			}
			renderYear();
		});

		__WEBPACK_IMPORTED_MODULE_2_jquery__('#minOccurancesInput').change(function(e){
			// debugger;
			if(e.currentTarget.value == ''){
				currentMinOccurances = '0';
				__WEBPACK_IMPORTED_MODULE_2_jquery__('#currentMinOccurances').html(currentMinOccurances);
			} else {
